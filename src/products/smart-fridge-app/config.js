export const smartFridgeConfig = {
  ...
  versionHistory: [
    ...
    },
    {
      ...
      date: '2024-08-15',
      changes: [
        '【1】优化 智能冰箱统计与上报分离，开关门后本地盘点统计更新，不上报平台',
        '【2】上报WCS改为每天2次，中午12点-1点之间与晚上12点-1点之间，由app随机生成时间(0-60分钟)中的某一分钟开启扫描，共扫描十次，再通过系统排除异常标签、幽灵标签、特殊物料等综合情况将冰箱中最真实的库存数据上报到WCS中。',
        '【3】新增扫描动画与开门动画',
        '【4】优化冰箱在原有功能上进行界面优化',
        '【5】优化缓存升级，优化冰箱长时间开机的卡顿问题,由直接读取数据库改为存入缓存，日志默认展示最近3天日志，最大支持查询30天日志'
      ]
    },
    {
      version: '1.0.2',
    ...
    },
    {
      ...
      date: '2024-09-30',
      changes: [
        '【1】升级扫描策略(关门后连续扫描3次，统计3次的扫描结果，扫描到2次以上的标签才算存放在冰箱中，统计结果后才上报)',
        '【2】提示语优化，登录页面新增扫描次数，扫描结果提示',
        '【3】余量功能优化，第一次存入100%，取一次减少10% ',
        '【4】优化：开机无操作开启后台扫描功能'
      ]
    }
  ],
  category: 'APP软件',
  tags: ['KM二代冰箱', 'KM三代冰箱', '灵控盒(4G)'],
